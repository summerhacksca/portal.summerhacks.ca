 ...
 * Escape to close, body scroll locked while open - with one addition it needs
 * and TrekPanel doesn't: closing itself on navigation, or it would sit open
 * over whichever page you just tapped through to.
 */
